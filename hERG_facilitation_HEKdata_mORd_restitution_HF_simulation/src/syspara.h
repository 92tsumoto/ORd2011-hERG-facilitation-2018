...
struct inastruct {
	...
	double h,hCaMK;
	double fast_phospho_CaMK;

	// Late sodium currnet
	double Gna_late,late;
	double mlss,tauml,hlss,tauhl,hlCaMKss,tauhl_CaMK;
	double *Tmlss,*Thlss,*ThlCaMKss;
	double late_phospho_CaMK;
...
struct ikrstruct {
	...
	double ik,without,with,Gkr,rategkr,rate;
	...
	double *Txrss,*Txrss2,*Ttauxr_fast,*Ttauxr_slow,*TAxr_fast;
	double *Trkr;
...
void current(FILE *,FILE *,FILE *,FILE *,FILE *,FILE *,FILE *,FILE *, FILE *, FILE *, double t,double x[]);
