...
#cat ../control/s2_860/ikr_data.out | awk '{print ($1-2000),$2}' > cont0.dat
#cat ../without_0.52175/s2_860/ikr_data.out | awk '{print ($1-2000),$2}' > cont1.dat
#cat ../with_0.43334/s2_860/ikr_data.out | awk '{print ($1-2000),$2}' > cont2.dat
